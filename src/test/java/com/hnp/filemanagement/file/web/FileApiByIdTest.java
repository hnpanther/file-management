...
class FileApiByIdTest extends DatabaseSupport {
    ...
    @Autowired
    private com.hnp.filemanagement.identity.domain.ApiKeyService apiKeyService;
    @Autowired
    ...
    private String apiKey(String... grants) {
        com.hnp.filemanagement.identity.domain.ApiKeyDTO request = new com.hnp.filemanagement.identity.domain.ApiKeyDTO();
