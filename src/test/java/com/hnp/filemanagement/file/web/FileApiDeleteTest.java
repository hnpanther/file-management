...
class FileApiDeleteTest extends DatabaseSupport {
    ...
    @Autowired
    private com.hnp.filemanagement.file.domain.FileService fileService;
    ...
    void deletingOneVersionLeavesTheOther() throws Exception {
        ...
        com.hnp.filemanagement.file.domain.FileUploadDTO second = new com.hnp.filemanagement.file.domain.FileUploadDTO();
