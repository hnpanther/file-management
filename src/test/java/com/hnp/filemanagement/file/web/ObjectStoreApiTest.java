...
class ObjectStoreApiTest extends DatabaseSupport {
    ...
    @Autowired
    private com.hnp.filemanagement.file.persistence.FileInfoRepository fileInfoRepository;
    ...
    void aNonAsciiKeyIsStoredAsWritten() throws Exception {
        ...
        org.assertj.core.api.Assertions.assertThat(fileInfoRepository.findAll())
                .extracting(com.hnp.filemanagement.file.domain.FileInfo::getFileName)
                .contains(name)
